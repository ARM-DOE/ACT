...
Some ACT contributors and maintainers use AI tools as part of their development
...
ACT-specific additions for CI, packaging, and dependency changes.
...
All code in ACT is released under the BSD 3-clause copyright license.
Contributors to ACT license their code under the same license when it is
included in ACT's version control repository. That means contributors must
own the copyright of any code submitted to ACT or must include the
...
licensing, or maintenance implications of adding a new dependency, and ACT —
...
ACT has domain-specific semantics such as instrument data conventions, terminology
