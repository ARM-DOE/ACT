...
# The corresponding qualit control DataArray is also read in and
...
# Create the top plot of data using the force_line_plot=True option.
# This will force the plotting to not assume the data are 2D data that
# would normally be plotted as a 2D plot, but for each index into the
