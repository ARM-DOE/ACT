...
def test_clean_sirs_siri_qc():
    EXAMPLE_SIRS_SIRI_QC = '/data/archive/sgp/sgpsirsC1.b1/sgpsirsC1.b1.20040101.000000.cdf'
    ...
    assert ds["qc_short_direct_normal"].attrs['flag_masks'] == [1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768]
    ...
    assert ds["qc_up_long_hemisp"].attrs['flag_meanings'] == [
        ...
        'Failed 1-component test; lower than allowed minimum', 'Failed 1-component test; higher than allowed maximum',
