...
Ready to contribute? Here's how to set up `act` for local development.

1. Fork the `arm-community-toolkit` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/arm-community-toolkit.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development::

    $ mkvirtualenv arm-community-toolkit
    $ cd arm-community-toolkit/
