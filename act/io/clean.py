...
class CleanDataset(object):
    ...
    def matched_qc_variables(self):
        ...
        qc_dict = {'description':["See global attributes for individual bit descriptions."]}
    ...
    def cleanup(self,
        ...
        **kwargs):
        ...
        clean_arm_state_vars : list of str
            Option to clean xarray object state variables from ARM to CF standars.
        ...
        # Clean up ARM QC to be more like CF state filelds
        if cleanup_arm_qc: 
        ...
        # Update to add some ancillary_variables linkages between variable and QC variable
    ...
    def handle_missing_values(self, **kwargs):
        ...
        if 'additional_missing_values' in kwargs.keys():
            additional_missing_values = kwargs['additional_missing_values=None']
        ...
        for var in self._obj.data_vars:
            ...
            try:
                ...
                self._obj[var].attrs['missing_value'] = copy.copy(missing_values[0])
    ...
    def correct_valid_minmax(self, qc_variable):
        '''Function to correct the name and location of QC limit variables that use
    ...
    def link_variables(self):
        ...
        for var in self._obj.data_vars:
            ...
            if not qc_variable in ancillary_variables:
    ...
    def clean_arm_qc(self, **kwargs):
        ...
        for qc_var in self.matched_qc_variables:
            ...
            # Add new attributes to variable
            for attr in ['flag_masks','flag_meanings','flag_assessments']:#,'flag_tests']:
                try:
