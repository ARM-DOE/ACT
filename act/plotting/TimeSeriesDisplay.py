...
class TimeSeriesDisplay(Display):
    ...
    def plot(self, field, dsname=None, subplot_index=(0, ),
             ...
             y_rng=None, use_var_for_y=None, shading=True,
        ...
        shading : boolean
            ...
            Set shading=False to set the shading parameter using kwargs.
            If shading is set to False and no shading kwarg is set, matplotlib defaults to
            shading='flat'.
        ...
        **kwargs : keyword arguments
        ...
        if ydata is None:
            ...
            # Set shading parameter to auto. Matplotlib will check deminsions.
