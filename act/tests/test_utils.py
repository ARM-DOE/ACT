...
def test_calculate_dqr_times():
    ...
    aos_ds.qcfilter.add_equal_to_test('stack_purge_state', 1)
    aos_result = act.utils.qc_utils.calculate_dqr_times(
        aos_ds, variable='stack_purge_state', qc_bit=1, threshold=30)
